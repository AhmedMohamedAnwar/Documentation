...
- Tee **show in terminal** + **store result in file.**
- Tee is used with | 
```bash
...
- TTY [If there is :0 mean the user connected by tty on physical first monitor 0 is first monitor :1 = second monitor]
